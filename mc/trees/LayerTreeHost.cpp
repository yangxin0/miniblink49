...
// void LayerTreeHost::setNeedsCommit() // ��ʱ����������setLayerTreeDirty����
// {
//     // �ɹ�դ���߳���������������������ֱ��ָ����Ҫ��ʼ��һ֡����ɾ����Ϻ��ɹ�դ���߳�ͨ��requestRepaint�����ػ�
...
{
    // ��������������LayerTreeHost����Ϊpopup ���͵Ļ���´��ڵ�layer���ñ��ӿڵ��ϵ�host����
...
void LayerTreeHost::requestApplyActionsToRunIntoCompositeThread(bool needCheck)
{
    ...
    if (0 != m_requestApplyActionsCount && !needCheck) // ���needCheck==true�����ʾ���˳����̣�����ִ��һ��onApply
        return;
...
void LayerTreeHost::drawFrameInCompositeThread()
{
    ...
    if (detTime < m_drawMinInterval && !m_isDestroying) { // ���ˢ��Ƶ��̫�죬�����ٻ�
...
//     s_time = t1;
    ...
    bool frameReady = preDrawFrame(); // ����Ҳ�ᷢ��Commit
    if (!frameReady) {
...
void LayerTreeHost::paintToMemoryCanvasInCompositeThread(const SkRect& r)
{
    ...
    double t1 = WTF::currentTimeMS();
    bool needNotifUi = drawToCanvas(m_memoryCanvas, paintRect); // ���������
