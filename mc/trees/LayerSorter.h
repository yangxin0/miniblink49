...
#ifndef mc_LayerSorter_h
#define mc_LayerSorter_h
...
template <>
struct hash<mc::GraphEdge*> {
  size_t operator()(mc::GraphEdge* ptr) const {
...
using mc_blink::WebLayerImplList;
...
struct GraphNode {
    explicit GraphNode(mc_blink::WebLayerImpl* layer_impl);
    ~GraphNode();

    mc_blink::WebLayerImpl* layer;
    LayerShape shape;
