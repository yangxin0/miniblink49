...
if(NOT MB_OS_WINDOWS)
    target_include_directories(mc PUBLIC "${CMAKE_SOURCE_DIR}/win_compat")  # <windows.h> shim
endif()
...
if(MSVC)
    # Match the V8 monolith's no-RTTI ABI; force-include the real SDK windows.h.
    target_compile_options(mc PRIVATE "/GR-" "/FIwindows.h")
else()
