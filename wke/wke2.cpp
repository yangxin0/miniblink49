...
static int getWindowDPI(HWND hWnd)
{
    ...
    int dpiX = ::GetDeviceCaps(screenDC, LOGPIXELSX);//96��100%��120��125%
...
const wkePdfDatas* printToPdf(wkeWebView webView, blink::WebFrame* frame, const wkePrintSettings* params, bool isPrintToMultiPage)
{
    ...
    int windowDPI = 72; // chromium����desired_dpi=72Ӳ���룬������getWindowDPI(webView->windowHandle());
    int dpi = params->dpi;
    int srcWidth = convertUnit(params->width, dpi, kPointsPerInch); // ת����pt��������DPI��72������Ҳ����˵��px
