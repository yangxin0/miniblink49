...
#ifdef _DEBUG
//static_assert(sizeof(StringImpl) == (3 * sizeof(unsigned) + sizeof(void*)), "StringImpl should stay small");
#else
...
public:
    SlowBufMgr()
    {
        ...
        for (int i = 0; i < kMaxSize; ++i) {
            ...
            m_buf[i]->index = kIsIdleFlag; // kIsIdleFlag ��ʾ����
            m_buf[i]->size = 0;
...
void* slowMalloc(size_t size)
{
    ...
    head->index = SlowBufMgr::kSysMallocFlag; // -5 ��ʾϵͳ����
    head->size = size; //
    return head + 1;
}
