...
#if defined(_WIN32)
// hook �������͵ģ�76121030    FF 25 2C 90 18 76    jmp dword ptr [__imp__NtUserBeginPaint@8 (7618902Ch)]
BOOL HookAddrByJmp(void* addr, PROC pfnNew, PROC* pfnOld)
{
    ...
    dwAddress = (DWORD)pfnNew - (DWORD)pFunc; //����Hook�����ͱ�Hook�����ĵ�ַƫ��

    memcpy(&pBuf[1], &dwAddress, 4); //��ƫ�Ƶ�ַƴ�յ���JMP XXXXx"��

    memcpy((LPVOID)((DWORD)pFunc - 5), pBuf, 5); //����JMP pfnNew��д��pFunc-5��λ�ã�Ҳ�������NOP��λ��

    // 2. MOV EDI, EDI (0x8BFF)
    // ����JMP-7��д��pFunc��λ�ã�Ҳ����MOV EDI, EDI��λ��
...
//     pSetThreadStackGuarantee(&stackSizeInBytes);
    ...
    // 75�汾����V8_CONCURRENT_MARKING_BOOL���б�����������վ��
    ...
    // �ǵ�����ua��"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like XSD) Chrome/79.0.3945.130 Safari/537.36"
    // 57�汾����incremental_marking����������ַҲ�б���
    ...
    const char* v8flags[] = {
        ...
        "--no_incremental_marking", // �ݲ�֧��incremental_marking����Ҫ��UnifiedHeapController::AdvanceTracing�ڶ����̣߳���Ϊû��v8::context���±���
