...
void V8ServiceWorkerMessageEventInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ServiceWorkerMessageEventInit& impl, ExceptionState& exceptionState)
{
...

    {
        ...
        if (sourceValue.IsEmpty() || sourceValue->IsUndefined()) {
            ...
            V8ServiceWorkerOrMessagePort::toImpl(isolate, sourceValue, source, exceptionState);
            if (exceptionState.hadException())
                return;
...
v8::Local<v8::Value> toV8(const ServiceWorkerMessageEventInit& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8EventInit(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    if (!toV8ServiceWorkerMessageEventInit(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}
