...
v8::Local<v8::Value> toV8(const PushPermissionDescriptor& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8PermissionDescriptor(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    if (!toV8PushPermissionDescriptor(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}
