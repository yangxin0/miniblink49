...
class /*BASE_EXPORT*/ CommandLine {
 public:
  ...
  explicit CommandLine(const StringType& program);
  ...
  StringType GetSwitchValuePath(const std::string& switch_string) const;
  ...
  void AppendSwitchPath(const std::string& switch_string, const StringType& path);
  ...
  void AppendArgPath(const StringType& value);
