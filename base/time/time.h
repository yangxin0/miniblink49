...
public:
    ...
    TimeDelta operator/(uint64_t a) const
    {
        return TimeDelta(delta_ / a);
    }
    TimeDelta operator/(uint32_t a) const
    {
        return TimeDelta(delta_ / a);
    }
    TimeDelta operator/(int a) const
    {
        return TimeDelta(delta_ / a);
    }
    TimeDelta operator/(double a) const
    {
        return TimeDelta((int64)((double)delta_ / a));
    }
    ...
    TimeDelta& operator/=(uint64_t a)
    {
        delta_ /= a;
        return *this;
    }
    TimeDelta& operator/=(int a)
    {
        delta_ /= a;
        return *this;
    }
    TimeDelta& operator/=(uint32_t a)
    {
        delta_ /= a;
        return *this;
    }
    TimeDelta& operator/=(double a)
    {
        double delta = delta_;
        delta_ = (int64)(delta_ / a);
        return *this;
    }
...
private:
    ...
    explicit TimeDelta(int64 delta_us)
        : delta_(delta_us)
    {
    }
...
namespace time_internal {
    ...
    public:
        ...
        static const int64 kMillisecondsPerDay = kMillisecondsPerSecond * 60 * 60 * kHoursPerDay;
...
protected:
    ...
    explicit TimeTicks(int64 ticks)
        : ticks_(ticks)
    {
    }
